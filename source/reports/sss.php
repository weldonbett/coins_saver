 ...
 function Footer()
{
    ...
    //Page number
    $this->Cell(0,10,'eZee technics ',0,0,'C');
}
...
$result=mysql_query("SELECT * FROM repair WHERE cat='$xx' OR name='$xx' OR serial='$xx' OR date= '$xx' ");
...
$header=array('CATEGORY','DEVICE NAME','SERIAL','PRICE',' OUT DATE');
